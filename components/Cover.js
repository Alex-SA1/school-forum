...
export default function Cover({url,editable,onChange}) {
    ...
    return (
        <div className="h-36 overflow-hidden flex justify-center items-center relative text-likeColor">
            <div>
              <img src={url} alt=""/>
            </div>
            {isUploading && (
        ...
        {editable && (
            <div className="absolute right-0 bottom-0 m-2 text-likeColor">
               <label className="flex items-center gap-2 bg-white py-1 px-2 rounded-md shadow-md shadow-black cursor-pointer">
               ...
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
                ...
                Schimbă imaginea de copertă</label>
            </div>
        )}
        </div>
    );
