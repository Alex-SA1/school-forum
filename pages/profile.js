      ...
      <UserContextProvider>
        <Card noPadding={true}>
          <div className="relative overflow-hidden rounded-md">
            ...
            <div className="p-4 pt-0 md:pt-4 pb-0 text-likeColor">
                  ...
                  <div className="text-right">
                    {isMyUser && !editMode && (
                      <button
                        ...
                        className="inline-flex mx-1 gap-1 bg-white rounded-md shadow-sm shadow-gray-400 py-1 px-2">
